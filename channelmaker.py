...
zipalign = "F:\\Android\\sdk\\build-tools\\28.0.3\\zipalign"
apksigner = "F:\\Android\\sdk\\build-tools\\28.0.3\\apksigner"
keystore = "xxx.jks"
key_alias = "xx"
...
if __name__ == '__main__':
    try:
        ...
        # 默认生成的 apk 目录
        apk_path = project_path + os.sep + "app" + os.sep + "build" + os.sep + "outputs" + os.sep + "apk"
